...
- [x] **OPT-01**: User can view an optimization score gauge (0-100%) for any business profile, computed from weighted signals (review frequency, post frequency, rating, images, description, services, attributes)
