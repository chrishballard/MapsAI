    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[300px] gap-3 text-center">
        ...
        <button
          type="button"
          onClick={() => onComplete()}
          className="bg-blue-600 text-white hover:bg-blue-700 rounded-md px-6 py-2.5 font-medium text-sm mt-2"
        >
          Go to Profile
        </button>
      </div>
        ...
        {steps.map((step) => {
          ...
          if (isReviewStep) {
            return (
              <div
                key={step.stepIndex}
                className="flex items-center gap-3 p-3 rounded-lg border border-gray-200 bg-blue-50"
              >
          ...
          return (
            <button
              ...
              className="w-full flex items-center gap-3 p-3 rounded-lg border border-gray-200 hover:bg-gray-50 cursor-pointer transition-colors text-left"
            >
              <StatusIcon className={`w-5 h-5 ${statusColor} shrink-0`} />
              <div className="flex-1 min-w-0">
                <p className="text-sm font-medium text-gray-900">
